...
M.general = {
  ...
  n = {
    ...
    ["<leader>f"] = { ":lua require('telescope.builtin').find_files()<CR>", "Open telescope", opts = { silent = true } },

    ["<leader>fw"] = {":lua require('telescope.builtin').live_grep()<cr>", "Word loopup", opts = { silent = true } },
    ["<leader>fe"] = {":lua require'telescope.builtin'.symbols{ sources = {'kaomoji', 'gitmoji'} }<cr>", opts = {silent = true }},
